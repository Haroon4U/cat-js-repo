    ...
    $(document).ready(async function() {
        ...
        $('select[name="cause_of_action"]').select2({ 
            placeholder: "Select Cause Action",
            theme: "classic",
            ajax: {
                url: root_url + '/demobilization/cause_action/many2One',
                dataType: 'json',
            }
        });
        ...
        try {
            ...
            await Promise.all([
                new Promise((resolve, reject) => {
                    $('[name="cause_of_action"]').append(new Option(data.demob.cause_of_action, data.demob.cause_of_action, true, true)).trigger('change');
